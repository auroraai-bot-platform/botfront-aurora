describe('Test stories searching ui', () => {
    ...
    it('find stories created on project init', () => {
    ...
    it('index stories that are created and edited in the app', () => {
    ...
    it('find stories created in the app', () => {
    ...
    it('link to forms from stories search', () => {
